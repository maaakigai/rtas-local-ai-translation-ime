...
set "DST_CONFIG_DIR=%~dp0Debug\config"
...
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
  ...
  "$p = Start-Process -FilePath \"$env:SystemRoot\\SysWOW64\\regsvr32.exe\" -ArgumentList '/s', $dll -Verb RunAs -PassThru -Wait; exit $p.ExitCode"
if %errorlevel% NEQ 0 (
